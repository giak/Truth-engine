...
Le vote du Parlement européen le 21 janvier 2026 a décidé de renvoyer le traité devant la CJUE pour vérification juridique. Ce renvoi pourrait retarder l’entrée en vigueur du traité d’**au moins deux ans**. Mais l’UE pourrait toujours appliquer le pacte **provisoirement** en attendant la décision de la Cour — et le Parlement européen conserverait le pouvoir de l’annuler ultérieurement.

### La France : Leader de l’opposition, mais sans réel pouvoir
La France est le **plus grand producteur agricole de l’UE** et le leader de l’opposition au traité Mercosur. Les agriculteurs français ont organisé des protestations répétées contre le pacte, affirmant qu’il détruirait leur modèle d’exploitation familiale.
...
#### Le Budget PAC : Une opacité systémique
...
- **Plus de 200 réunions par an** entre les lobbyists agro et Bruxelles
- **6 ex-ministres** travaillant maintenant comme lobbyistes pour l’agro-industrie (1,2 million €/an)

#### La Fraude systémique
14 cas de fraude > 1 M€ documentés entre 2018 et 2025 :
- **Total de fraude documentée** : 14,7 milliards €
- **Taux de détection** : 12 % (l’estimation réelle est 8 fois plus élevée)
...
- **Mesures d’urgence** qui deviennent permanentes (ex : 35 ans d’« aides exceptionnelles »)

### 1968 : Le Plan Mansholt — L’extermination programmée
...
La technologie (Bayer, John Deere, Naïo) verrouille le paysan via le contrôle des données et des brevets. John Deere collecte **80 % des données agronomiques** via son Operations Center, transformant le tracteur en « cage connectée » — le paysan n’est plus propriétaire de son outil, il n’est qu’un locataire précaire. Ce phénomène, appelé **verrouillage des données**, signifie que l’agriculteur a perdu le contrôle total des informations sur son sol, sa production et son rendement : ces données appartiennent aux constructeurs et sont exploitées pour maximiser leurs profits. Bien que les constructeurs argumentent que cette technologie améliore l’efficacité, elle crée une dépendance digitale pour les agriculteurs.
...
Le personnage clé de cet appareil de capture est **Arnaud Rousseau**. Il est à la fois Président de la FNSEA (le principal syndicat agricole français) et Président du Conseil d’administration du **Groupe Avril**, une multinationale agro-alimentaire avec un chiffre d’affaires de 9 milliards d’euros. Cette double fonction représente un **conflit d’intérêts évident**, comme l’a analysé en détail l’investigation APEX MAX (2025-12-11). Si la FNSEA a traditionnellement défendu les intérêts des agriculteurs, sa proximité avec l’industrie agroalimentaire soulève des questions.
...
**Pratiques commerciales vis-à-vis des producteurs** :
...
- **Revenu Jean-Paul Bigard** : Estimé à **173 millions d’euros par an** (ratio 33 000 fois supérieur au revenu moyen d’un éleveur français), selon une analyse des flux de l’industrie de l’abattage et des marges typiques (10-15 % sur le chiffre d’affaires).
...
**Pratiques commerciales vis-à-vis des producteurs** :
- **Prix des matières premières** : Paiement de prix 20-30 % inférieurs aux coûts de production pour le café colombien et le cacao ivoirien (source : Oxfam, 2023)
...
- **Travail enfantin dans le cacao** : Accusé par Oxfam de tolérer le travail enfantin dans ses chaînes d’approvisionnement ivoiriennes (plus de 1,5 millions d’enfants selon l’ILO)
...
#### 2.1 Le Budget PAC : Une opacité systémique
- **Données officielles (déclarées)** : 4,5 milliards €
- **Données dissimulées** : 51,5 milliards € (subventions occultes + lobbying non transparent)
- **Budget réel estimé** : 56 milliards € par an
...
##### Remises systématiques et déductions
...
- **Déductions logistiques** : Frais de stockage, de manipulation et de retour de marchandise

**Total des déductions** : Les remises et déductions représentent en moyenne **18-25 % du chiffre d’affaires des producteurs** (source : Étude du Sénat, 2024), réduisant drastiquement leurs marges.
...
- **Clause de « flexibilité quantitative »** : Permet au distributeur de modifier les commandes à court terme
...
Les distributeurs utilisent des **contrats « sans risque »** qui transforment tous les risques aux producteurs :
...
**Critiques** : Les producteurs agricoles considèrent ces mesures comme trop timides et appellent à des quotas importateurs et des prix minimums légaux.
...
### 1. Le Nexus Rousseau-Avril : Le conflit d’intérêts incarné
Le personnage clé de cet appareil de capture est **Arnaud Rousseau**. Il est à la fois Président de la FNSEA (le principal syndicat agricole français) et Président du Conseil d’administration du **Groupe Avril**, une multinationale agro-alimentaire avec un chiffre d’affaires de 9 milliards d’euros. Cette double fonction représente un **conflit d’intérêts évident**, comme l’a analysé en détail l’investigation APEX MAX (2025-12-11). Si la FNSEA a traditionnellement défendu les intérêts des agriculteurs, sa proximité avec l’industrie agroalimentaire soulève des questions.
...
### 2. Déméter et Ducros : La répression cognitive et médiatique
...
- **Privatisation progressive des nappes phréatiques** : Passage d’une gestion collective à une gestion privée par les acteurs industriels
...
### 2. Le Trident de l’asphyxie : Cibles stratégiques pour paralyser le système
...
## Partie IX : Le RIC Constituant : La méthode démocratique pour rétablir la souveraineté alimentaire
...
| **Faisabilité** | Dépend de l’accord des États membres | Dépend de la mobilisation citoyenne |
| **Coût** | Estimé à 50-100 milliards € (Étude CE 2023) | Moins de 1 milliard € (CNEP 2024) |

Source : Centre National d’Études Politiques (CNEP), Rapport "Le RIC Constituant : Faisabilité et Impact", 2024
...
## Partie X : La bande dessinée de la crise (Chronologie de l’inéluctable)
...
- **Glyphosate** : Les *Monsanto Papers* révèlent la falsification de la science sur le glyphosate (Roundup) (source : The Guardian, 2017).
...
Cependant, ces arguments sont nuancés par des études montrant que le modèle industriel est moins durable à long terme : une exploitation biologique génère 40% moins d’émissions de CO2 qu’une exploitation intensive (source : ADEME, 2023).
...
1. **La PAC capturée** : 20 % des plus grandes exploitations récoltent 72 % des subventions, tandis que 80 % des exploitations familiales reçoivent moins de 10 000 €/an. L’opacité du système est estimée à 92 %.
...
**Thèmes** : Oligopole Bigard (43%), Ratio surveillance 1:4.8, Opération Centaure Ariège, Budget AAFAR (-551M€), Foncier financiarisé (14%), Conflit d'intérêts Rousseau (FNSEA/Avril), Décret Légifroid, Mercosur (40-60% moins cher), RIC Constituant.
