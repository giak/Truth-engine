...
### 1.1 Citations verbatim identifiées

| # | Citation exacte | Source | Date approximative |
|---|----------------|--------|-------------------|
| 1 | « L'objectif de Volodymyr Zelensky avant le sommet de l'OTAN, c'est de dire qu'il est en train de gagner la guerre pour avoir de l'argent. » | CNews / L'Heure Inter | 2025 |
| 2 | « L'Europe n'est pas neutre dans ces négociations. » | CNews / L'Heure Inter | 2025 |
| 3 | « Les deux pays ont besoin de revenir vers des négociations. » | CNews / L'Heure Inter | 2025 |
| 4 | « Les Américains ne voient pas cette guerre comme la leur mais la font... » | CNews / L'Heure Inter | 2025 |
| 5 | « La Russie est capable d'aider l'économie française. » | CNews / Europe 1 (rapporté par Le Monde, INA) | 2025 |

### 1.2 Autres positions documentées (citations non verbatim, mais contenu établi par sources multiples)

| # | Position / Déclaration | Source |
|---|------------------------|--------|
| 6 | A qualifié la déportation d'enfants ukrainiens de « légendes » | Recoupement Le Monde, Libération, strate 13 du dossier |
| 7 | A utilisé le vocabulaire officiel russe « opération militaire spéciale » au lieu de « guerre » ou « invasion » | Recoupement presse, saisine Renew Europe |
| 8 | A critiqué les sanctions européennes contre la Russie comme inefficaces | Saisine Renew Europe, rapports de presse |
| 9 | A affirmé que le débat médiatique français exclut le point de vue russe | Son propre tweet du 3 juin 2026 (241K vues) |
| 10 | A défendu que la France devrait débattre de « souveraineté, d'énergie, d'équilibre continental ou d'indépendance stratégique » plutôt que de suivre la ligne pro-guerre | Son propre tweet du 3 juin 2026 |

### 1.3 Ce que Fedorova N'A PAS dit

Aucune citation documentée ne montre Fedorova :
...
## 2. Ce que l'arrêté d'expulsion lui reproche

Le texte intégral de l'arrêté ministériel d'expulsion n'est pas public. Les extraits disponibles proviennent des recoupements de presse (Libération, Le Monde, LCP, AFP) et des citations faites par l'avocat Me Emmanuel Piwnica et les parties au dossier.

### 2.1 Griefs articulés par l'arrêté

| # | Grief | Formulation rapportée |
|---|-------|----------------------|
| A | « Menace particulièrement grave et actuelle pour l'ordre public » | Formule standard du CESEDA L631-1 |
| B | « Atteinte aux intérêts fondamentaux de l'État » | Qualification de sécurité nationale |
| C | « Relais des campagnes de désinformation pilotées par les autorités russes » | Accusation de coordination avec un État étranger hostile |
| D | « Diffusion d'un discours de désinformation et de déstabilisation visant à manipuler l'opinion publique » | Accusation d'ingérence informationnelle |
| E | « Saper la confiance des citoyens européens et en particulier des citoyens français en leurs institutions » | Accusation de subversion démocratique |

### 2.2 Ce que l'arrêté NE contient PAS

- **Aucune citation spécifique** des propos de Fedorova (aucun propos n'est retranscrit dans l'arrêté)
- **Aucune condamnation judiciaire** antérieure
- **Aucune référence à une procédure pénale** en cours
- **Aucune référence à une décision de l'Arcom** interdisant ou sanctionnant ses chroniques
- **Aucune preuve publique** de coordination avec les « autorités russes » (les éventuelles notes de la DGSI sont classifiées)
- **Aucune référence à des propos appelant à la violence ou à la haine**
...
**Déclarations de Fedorova potentiellement concernées :** 1, 2, 4, 9, 10

**Analyse :** Fedorova critique :
- Les motivations de Zelensky (citation 1)
- La partialité de l'Europe (citation 2)
- Le rôle des États-Unis (citation 4)
...
### 3.4 Griefs A et B : « Menace à l'ordre public » et « atteinte aux intérêts fondamentaux de l'État »

**Analyse :** Ces deux griefs sont les plus graves et les plus vagues. Ils sont les « griefs-chapeaux » qui coiffent tous les autres.

**Problème structurel :** Les notions de « menace à l'ordre public » et d'« atteinte aux intérêts fondamentaux de l'État » sont définies de manière extrêmement large par le CESEDA et la jurisprudence administrative. Elles peuvent couvrir :
...
**Verdict sur ces griefs :** Juridiquement possible (le texte le permet) mais politiquement arbitraire (aucun comportement illégal n'est documenté). L'État utilise la plasticité du droit des étrangers pour contourner les garanties du droit de la presse.

---

## 4. L'angle justice

### 4.1 La procédure est administrative, pas judiciaire

L'OQTF est une procédure administrative. Elle ne mobilise ni juge d'instruction ni tribunal correctionnel. La Commission d'expulsion (COMEX), qui émet un avis préalable, est présidée par un magistrat mais son avis est purement consultatif. Le ministre n'est pas lié par cet avis. Le tribunal administratif peut être saisi en recours, mais le recours n'est pas suspensif : l'expulsion peut être exécutée avant que le juge ne statue.

**Conséquence :** L'arrêté frappe avant que le juge ne l'examine. La présomption d'innocence et le droit au contradictoire sont structurellement absents de la phase d'exécution.

### 4.2 Le contrôle juridictionnel est structurellement favorable à l'État
...
## 5. L'angle Union européenne

### 5.1 La France a REFUSÉ de soumettre Fedorova aux sanctions européennes

Le 22 juillet 2026, Edwy Plenel pose dans Le Monde la question : pourquoi la France n'a-t-elle pas réclamé l'ajout de Fedorova au nouveau paquet de sanctions européennes ? La réponse, documentée par Le Monde et les couvertures des négociations du 16e paquet de sanctions : **la France s'y est opposée.**

Selon Le Monde, la France a estimé que « le moment n'était pas venu » (« the time isn't right ») pour inclure Fedorova dans les sanctions individuelles européennes. Paris a explicitement choisi de traiter son cas par la voie nationale plutôt que par la voie européenne.

**Ce choix est le cœur du dossier.** Si la France détenait des preuves accablantes contre Fedorova, elle les aurait produites devant ses partenaires européens pour obtenir une sanction individuelle. Le refus de la voie européenne suggère que le dossier est soit trop faible pour convaincre 26 autres États, soit trop utile politiquement pour être dilué dans un paquet bruxellois.

### 5.2 Chronologie : L'OQTF comme plan A, pas plan B
...
| **Condamnation judiciaire ?** | Aucune | Aucune |

**La variable déterminante est le passeport.**
...
## 6. Le parallèle avec Xavier Moreau

### 6.1 Points communs

| Critère | Fedorova | Moreau |
|---------|----------|--------|
| Alignement pro-russe | Oui | Oui |
| Activité visée | Chroniques médiatiques | Analyses géopolitiques, interventions médiatiques |
| Condamnation judiciaire | Aucune | Aucune connue |
...
- L'OQTF n'est **pas étayée** par des faits publiquement verifiables. Aucun propos spécifique n'est cité dans l'arrêté. Aucune condamnation judiciaire n'existe. Aucune décision de l'Arcom n'interdit ses chroniques. Aucune preuve publique de coordination avec Moscou n'est produite.
- L'OQTF n'est **pas non plus « totalement injuste »** au sens d'une décision arbitraire sans fondement juridique. Le CESEDA L631-1 autorise l'expulsion pour menace à l'ordre public. La jurisprudence laisse une large marge à l'administration. La décision est juridiquement valide en droit interne, même si elle est juridiquement contestable en droit européen des droits de l'homme.
- **Mais le fondement n'est pas factuel, il est politique.** L'État a requalifié une activité d'opinion en menace à la sécurité nationale pour utiliser le droit des étrangers contre une personne que la loi de la presse ne permet pas de faire taire. Cette requalification est légale en France. Elle est contestable au regard de la Convention européenne des droits de l'homme.
...
La CourEDH a jurisprudencié :
- Le discours politique bénéficie d'une protection renforcée (arrêt *Lingens c. Autriche*, 1986)
- Les limites de la critique admissible sont plus larges pour les personnalités politiques que pour les particuliers (arrêt *Dichand c. Autriche*, 2002)
- L'expulsion d'un étranger pour des opinions politiques doit être strictement proportionnée (arrêt *Cox c. Turquie*, 2010)
...
## 9. Ce que l'image ne peut pas changer

L'image jointe au message initial ne peut être traitée par ce modèle (aucune capacité d'OCR ou d'analyse d'image). Si elle contient des documents additionnels (extraits de l'arrêté, nouvelles citations de Fedorova, éléments de contexte), ils devront être intégrés manuellement dans cette analyse.
