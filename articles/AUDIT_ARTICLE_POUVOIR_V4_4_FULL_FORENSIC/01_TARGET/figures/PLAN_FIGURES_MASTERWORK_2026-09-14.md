...
```mermaid
flowchart LR
  A["Sanctions secondaires US<br/>JCPOA, mai 2018"] --> B["Risque de coupure<br/>du clearing $"]
  B --> C["Retrait préventif<br/>TotalEnergies, 16 mai 2018"]
  B -. "incapable d'offrir une immunité" .-> R["Règlement UE 2271/96<br/>recours défaillant"]
```
...
```mermaid
flowchart TB
  A["3 agences mondiales<br/>AFP · Reuters · AP"] -- "dépendance mesurée NL ≤75 %, CH<br/>→ hypothèse UE NON MESURÉE" --> B["Rédactions en ligne<br/>dépendantes du matériel d'agence"]
  B --> C["Fact-checkers certifiés IFCN/EFCSN<br/>→ DSA art. 22 : signaleurs"]
  C --> D["Modération algorithmique<br/>déléguée (Meta / X)"]
```
