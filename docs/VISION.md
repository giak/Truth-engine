...
## Le Comment — Vision DSL

### Qu'est-ce que le DSL?

Ce n'est pas un langage de programmation. C'est **une façon de voir**.

Le DSL (Domain Specific Language) de Truth Engine est:
- Un vocabulaire de détection
...
### Le Scoring — La Quantification

Tout peut être mesuré. Chaque dimension reçoit un score 0-10. Les scores déclenchent des protocoles.

- Ξ ≥ 5 → Charger ICEBERG cluster
- € ≥ 5 → Charger MONEY cluster
- EDI < cible → Retourner en arrière

---

## L'État Actuel

**Truth Engine** est un système cognitif en fonctionnement.

```
Investigation → Métriques → Feedback → Amélioration → Investigation
```

Nous sommes en phase d'amélioration continue:
- Patterns ajoutés après détection
- Formules affinées après erreurs
- Nouveaux clusters selon besoins
