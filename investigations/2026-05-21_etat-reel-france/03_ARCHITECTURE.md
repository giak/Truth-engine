# ARCHITECTURE — État réel de la France : anatomie de la pourriture systémique

## §3.1 Chaîne de révélations

| # | Titre | Répond à | Révèle | Question suivante | Faits (D###) |
|---|-------|----------|--------|-------------------|-------------|
| 1 | La dette de 3 518 Mds€ n'est pas un accident | Pourquoi la dette explose-t-elle ? | 80-100 Mds€ de fraude fiscale non détectée chaque année — 4-5x le détecté | Qui profite de cette fraude ? | D001, D002, D003, D004, D007, D008, D009 |
| 2 | Le circuit de capture : ENA, pantouflage, médias | Qui écrit les règles ? | Les décideurs publics et privés sont les mêmes personnes — 93% presse → 5 milliardaires | Comment ce circuit s'étend-il à l'Afrique ? | D018-D031 |
| 3 | Françafrique : le circuit externe de prédation | D'où vient l'argent blanchi ? | Uranium Niger, Bongo 85 M€, 12 Mds€ ventes armes dictatures — la dette finance la prédation | Comment l'éducation s'effondre-t-elle ? | D011-D017, D032-D036, D042-D047 |
| 4 | Éducation : un pays qui ne sait plus lire | Comment la capture se reproduit-elle ? | PISA 23e, 64% démissions, 20% illettrisme — seule l'élite ENA est formée | Comment le quotidien se détruit-il ? | D048-D052 |
...
|---------|----------------------|-------------|---------|------|--------|
| §1 Dette & fraude | inv v4 6.1, 6.2, 6.15 | D001-D010 | Insee, ATTAC, Bercy, Sénat, AN | dettedelafrance.fr, franceinfo.fr, senat.fr | ✦ |
| §2 Circuit capture | inv v4 6.1, 6.3, 6.4 | D018-D031 | HATVP, Transparency, Basta!, Obs. multinationnes, La Croix | hatvp.fr, basta.media, liberation.fr | ✦ |
| §3 Françafrique | inv v4 6.2, 6.5, 6.13 | D011-D017, D032-D036, D042-D047 | Sénat 757, AFA, Survie, RFI, L'Express, Transparency, OMSAC | senat.fr, survie.org, rfi.fr | ✦ |
| §4 Éducation | inv v4 6.14 | D048-D052 | IFRAP, OCDE, Snes-FSU, Cafepédagogique | ifrap.org, orange.fr | ✦ |
| §5 Logement & retraites | inv v4 6.17, 6.18 | D060, D061 | Fondation Abbé Pierre, COR, IFRAP | fondationpourlelogement.fr, capmad.com | ✦ |
...
## §3.3 Règles de non-répétition

- D001 (dette 3 518 Md€) : §1 uniquement, référence rétrospective au verdict
...
- §1→§2 : « 125-165 Mds€ s'évaporent chaque année. Cette fraude n'est pas un accident — elle est structurellement protégée. »
- §2→§3 : « Le circuit de capture ne s'arrête pas aux frontières françaises. Il s'étend à l'Afrique. »
- §3→§4 : « Pendant que l'argent africain blanchit à Paris, le système éducatif français s'effondre. »
- §4→§5 : « Un pays qui ne sait plus lire ne peut pas se défendre. Un pays qui laisse 735 personnes mourir dans la rue ne se défend pas non plus. »
- §5→§6 : « Le logement et les retraites incarnent l'inversion morale. L'environnement en incarne la destruction physique. »
