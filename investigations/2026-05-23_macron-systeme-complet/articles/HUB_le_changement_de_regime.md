...
```mermaid
flowchart TD
    T1["💰 Extraction<br/>200 milliards d'impôts<br/>non perçus par an"]:::t1
    T2["🔒 Capture<br/>9 propriétaires contrôlent<br/>90 % des médias"]:::t2
    ...
    classDef t4 fill:#7c3aed,color:#fff,stroke:none,rx:8px
