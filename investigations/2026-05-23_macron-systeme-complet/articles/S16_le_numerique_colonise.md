...
<!-- ENRICHIE: la-colonisation-silencieuse -->
<!-- THEME: colonisation-numerique -->
<!-- CROSS-REF: S14, S15 -->
...
**95 % du marché des données personnelles est capté par les géants américains.** Google et Meta contrôlent à eux seuls plus de 80 % du marché publicitaire français, selon France Num. **Aucune entreprise française ne figure dans le top 20 mondial du numérique.** Les données des citoyens français sont monétisées, analysées, vendues, sans qu'un centime de cette valeur ne reste en France.

<!-- ENRICHIE: les-gafam-un-impot-sans-consentement -->
<!-- THEME: extraction-fiscale -->
<!-- CROSS-REF: S2, S4 -->
...
<!-- ENRICHIE: le-cloud-act-des-donnees-sous-droit-americain -->
<!-- THEME: souverainete-perdue -->
<!-- CROSS-REF: S14, S15 -->
...
**Le cadre HDS (Hébergeurs de Données de Santé)** devait garantir que les données médicales sont hébergées en France sous droit français. **Mais Microsoft Azure et Amazon Web Services ont obtenu la certification HDS**, selon la liste officielle des hébergeurs agréés par l'ANS (Agence du Numérique en Santé). En conséquence, les données médicales des hôpitaux français (diagnostics, traitements, antécédents, informations génétiques) peuvent être stockées sur des serveurs américains, accessibles via le Cloud Act.
...
La France a lancé plusieurs projets de cloud souverain. Tous ont échoué ou n'ont pas atteint leurs objectifs.
...
### Bleu, un cloud souverain sous dépendance américaine
...
**La polémique a été vive.** La CNIL avait pourtant recommandé la prudence, selon son avis public sur le marché Microsoft Éducation. Plusieurs associations (La Quadrature du Net, EPI) ont alerté sur les risques juridiques, comme le rapporte ZDNet. Le contrat a été signé quand même. **Les outils Google (Classroom, Workspace) sont également utilisés massivement dans les établissements, sans garanties juridiques, selon Le Monde (2024).**

<!-- ENRICHIE: leducation-nationale-confiee-a-microsoft -->
<!-- THEME: dependance-education -->
<!-- CROSS-REF: S1, S3 -->
...
## §7 : La cybersécurité, le vase qui fuit
...
**Les attaques contre les services publics sont en hausse constante :** hôpitaux, préfectures, collectivités territoriales. En 2025, l'ANSSI a recensé plus de 2 000 attaques significatives contre les collectivités territoriales, souvent des rançongiciels qui paralysent les services publics pendant des semaines, selon son Panorama de la cybersécurité 2025.
