...
La France consacre **12,3 % de son PIB à la santé**, le plus haut niveau de l'OCDE, selon la DREES. Pourtant, les indicateurs de performance du système public s'effondrent sur tous les fronts.

> **Pourquoi la France, qui dépense le plus pour sa santé, a-t-elle un système public qui laisse 8 millions de citoyens sans médecin traitant ?**
...
## §1 : L'hôpital public vidé de sa substance

**100 000 lits d'hospitalisation ont été supprimés en France entre 2003 et 2023**, dont 28 000 depuis 2017, selon la Fédération hospitalière de France. C'est l'équivalent de la capacité d'accueil de 140 hôpitaux de taille moyenne qui ont disparu du paysage sanitaire.

### Le mécanisme destructeur : la tarification à l'acte

La T2A (tarification à l'acte), généralisée en 2008, finance les hôpitaux sur la base du nombre d'actes réalisés, pas sur la qualité des soins ni la permanence du service. Un lit d'hospitalisation coûte de l'argent quand il est vide et n'en rapporte pas assez quand il est occupé. La rationalité gestionnaire est simple : supprimer les lits, réduire les effectifs, fermer les services non rentables.

25 rapports parlementaires ont critiqué ce système depuis 2017, dont le rapport Laforcade (2023) et le rapport Braun (2022), selon les archives de l'Assemblée nationale. Aucun n'a été suivi d'effet. La T2A reste le mode de financement dominant, parce qu'elle sert un objectif politique : faire baisser les coûts apparents de l'hôpital public en transférant la charge vers le patient et le secteur privé.

### Des urgences qui ferment

En 2024, **120 services d'urgence ont dû fermer partiellement ou totalement la nuit**, faute de personnel, selon Samu-Urgences de France. Ces fermetures ne sont pas temporaires : certaines durent des semaines, des mois, parfois définitivement. Les patients doivent parcourir 30, 50, parfois 80 kilomètres pour trouver un service d'urgences ouvert.

Le **temps d'attente moyen aux urgences atteint 4 heures**, selon le ministère de la Santé. Dans les établissements en tension (Île-de-France, PACA, Occitanie), il dépasse 8 heures. Le taux d'occupation des lits hospitaliers dépasse régulièrement le seuil critique de 85 %, au-delà duquel la qualité des soins se dégrade et la sécurité des patients est compromise, selon la DREES.
...
## §2 : 8 millions de Français sans médecin traitant

**8 millions de personnes** n'ont pas de médecin traitant en France en 2025, selon la CNAM. C'est 1 Français sur 8 qui ne peut pas consulter un généraliste référent. Et ce chiffre ne cesse d'augmenter : il était de 6,5 millions en 2024.

### 40 millions de personnes en zone sous-dotée

**55 % de la population française** vit dans une zone insuffisamment dotée en offre de soins, selon MGFrance. Ce n'est plus un phénomène rural : les déserts médicaux gagnent les zones péri-urbaines et certains quartiers des grandes villes.

La France compte **117 médecins généralistes pour 100 000 habitants**, sous la moyenne européenne qui est d'environ 130, selon la DREES. Mais ce ratio national masque des disparités territoriales massives : dans certaines zones sous-dotées, la densité tombe à quelques généralistes pour 100 000 habitants. Le nombre total de généralistes en exercice a baissé de 8 % entre 2010 et 2020, et les départs à la retraite ne sont pas compensés par les installations de jeunes médecins. Cette pénurie n'est pas une conséquence directe de la T2A ou des politiques macronistes : elle est le résultat du numerus clausus, ce quota de médecins formés imposé de 1971 à 2020, qui a artificiellement restreint les vocations pendant un demi-siècle. Le numerus clausus a été supprimé en 2020, mais ses effets se feront sentir encore 10 à 15 ans, le temps que les promotions formées arrivent sur le terrain.

### Le renoncement aux soins

**25 % des Français déclarent avoir renoncé à des soins pour des raisons financières** en 2024, selon le baromètre du CISS. Dentiste, ophtalmologue, gynécologue, dermatologue, psychiatre : les spécialités où les délais d'attente sont les plus longs et les dépassements d'honoraires les plus fréquents.

Le renoncement n'est pas une décision médicale, c'est une **conséquence directe de l'organisation du système** : quand un patient doit attendre 6 mois pour un rendez-vous chez un spécialiste ou payer 50 euros de dépassement d'honoraires, il renonce. Son état s'aggrave, il finit aux urgences, qui coûtent plus cher à la collectivité qu'une consultation préventive.

### Des pénuries de médicaments

En 2024, **5 300 signalements de rupture de stock de médicaments** ont été recensés par l'ANSM, contre 800 en 2018. Antibiotiques, antidouleurs, médicaments pour le cœur, anticancéreux : des traitements vitaux sont régulièrement indisponibles, faute de production locale et de stocks de sécurité suffisants.
...
## §3 : La médecine à deux vitesses

Le système de santé français n'est plus un système solidaire. C'est un **système à deux vitesses** : un parcours public sous-financé, saturé, dégradé, et un parcours privé confortable, rapide, cher.
...
## §4 : Le grand âge abandonné

Le vieillissement de la population française est une tendance démographique connue depuis 30 ans. Les réponses publiques sont inexistantes.

### Les EHPAD en souffrance

Les établissements d'hébergement pour personnes âgées dépendantes accueillent **600 000 résidents** dans environ 7 500 établissements, selon la CNSA. Le coût médian d'un EHPAD représente **78 % de la pension de retraite moyenne**, selon la CNSA. Le ratio de personnel est d'un aide-soignant pour 12 résidents en moyenne, insuffisant pour assurer des soins de qualité.
