...
> 85 événement(s) classé(s) dans la dimension POL pour l'année 2026.
...
| 2026 | POL | 23 objets de communication interministériels imposés à tous les ministères (mars 2026) | ❌ |
| 2026 | POL | Création d un pôle événementiel mutualisé + plans annuels de communication par ministère (janv 2026) | ⚠ |
| 2026 | POL | Conclusions de la mission IGF/IGA/IGAS sur la réforme de la communication d État (avril 2026) | ⚠ |
| 2026 | POL | 45% des Francais pensent que la democratie est en danger en France (sondage IFOP/Le Monde) | ❌ |
| 2026 | POL | Alliance Police Nationale appelle a des rassemblements citoyens (31 janvier 2026) — premier syndicat policier en rue, soutien RN | ❌ |
| 2026 | POL | Sondages secrets du SIG aupres des Francais : 76% veulent plus d independance editoriale des medias | ❌ |
