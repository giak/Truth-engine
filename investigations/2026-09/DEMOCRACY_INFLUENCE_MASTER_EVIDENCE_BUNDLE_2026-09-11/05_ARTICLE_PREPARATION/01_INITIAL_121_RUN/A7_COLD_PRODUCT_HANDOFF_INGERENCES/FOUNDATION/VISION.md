...
doc:
  ...
  type: foundation
  title: Vision du protocole Article from Truth Engine
  version: V4.4-R1-candidate
  status: candidate_repair
  authority: normative_candidate
summary: >
  Définit la mission, les frontières d'autorité et les propriétés à préserver
  lorsque des investigations Truth Engine deviennent un article.
derives_from:
  - FOUNDATION.VISION.V4_4
non_regression_oracles:
  - PARENT_V4_3/VISION_V4_3.md
...
Sur un corpus multi-investigations, comprendre implique aussi de rechercher les **relations matérielles entre investigations** lorsqu'elles peuvent changer l'explication : complémentarités, recouvrements, contradictions, supersessions, évolutions temporelles, mécanismes transversaux, relations nouvelles, trous communs ou changements d'échelle. Une découverte peut n'exister que dans la relation entre plusieurs investigations.

```text
N_INVESTIGATIONS != ONE_BIG_SUMMARY
```

---

<!-- NODE: VISION.REINVESTIGATE -->
...
Avant la prose longue, la décision d'auteur doit aussi rendre explicites, à la profondeur nécessaire au dossier : le vrai sujet, la question ou thèse organisatrice, la tension principale, les découvertes et mécanismes indispensables, ce qui peut être coupé sans perte matérielle, l'intention de progression cognitive et la conclusion probable avec sa borne. A4 construit la progression et la prose ; il ne doit pas inventer silencieusement ces décisions pendant l'écriture.
