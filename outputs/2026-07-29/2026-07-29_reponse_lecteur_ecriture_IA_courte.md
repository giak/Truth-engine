...
Derrière l'article que vous avez quitté : dix-neuf enquêtes distinctes documentées dans le dossier, trois phases d'écriture et de vérification, des centaines de corrections par version, attestées par le journal de versionnement du dépôt, et 16 à 30 heures de travail selon la complexité, un chiffre qui est une déclaration de l'auteur et ne sort d'aucun compteur. 118 articles publiés en dix mois avec la même exigence (j'avoue que certains sont de moindre qualité). Alors voici le défi, pour le « prompteur » que vous imaginez : produisez un article de cette rigueur avec quelques prompts.

## Ce que votre commentaire évite

L'article que vous avez quitté autopsie un documentaire de 94 minutes. Six actes narratifs, vingt-huit séquences, chaque timecode vérifié, les sources citées une à une. Il documente comment des coopérations réelles sont transformées en menace totale par une série d'opérations successives : agrégation, militarisation, totalisation, absorption des crises, attribution d'un plan, mobilisation.
