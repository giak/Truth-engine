...
graph TB
    ...
    subgraph "Niveau Opérationnel"
        GIFCT["GIFCT (2017)
        Meta/MS/YouTube/X"]
        CC["Christchurch Call
        55 pays"]
    end

    subgraph "Niveau Influence"
        RAN["RAN
        6 500 membres"]
        HED["Hedayah
        Abu Dhabi"]
...
| Critère | URSS (1917-1991) | UE (2015-2026) | Innovation |
|---------|------------------|----------------|------------|
| Architecture | Goskomnadzor → KGB | EUIF → GIFCT → DSA | +Partenariat public-privé |
| Censure | Manuelle | Algorithmique (IA) | +Efficacité massive |
| Base de données | Fichiers NKVD | Hash-sharing GIFCT | +Vitesse de propagation |
| Critères | "Anti-soviétique" | "Borderline content" | +Fluidité sémantique |
| Satire politique | Interdite | Surveillée | +Déni plausible |
| Shadowbanning | Non disponible | Downranking algorithmique | +Sophistication technique |
| Couverture émotionnelle | "Protection du peuple" | "Protection de l'enfance" | +Légitimité moderne |
| Transparence | Zéro | Apparente | +Illusion démocratique |
| **Score (60 points)** | **28/60** | **44/60** | **+16 points** |
...
| Phase | Période | Mécanisme | Couverture |
|-------|---------|-----------|------------|
| **1. Volontaire** | 2015-2019 | Codes de conduite | Terrorisme |
| **2. Régulée** | 2019-2024 | DSA | "Borderline content" |
| **3. Coercitive** | 2024-2025 | Amendes 6% CA | Discours politique |
| **4. Totale** | 2025+ | Democracy Shield | Contrôle systémique |
...
| Acteur | Bénéfice | Évaluation |
|--------|----------|------------|
| Commission européenne | Expansion réglementaire | ÉLEVÉ — Croissance du pouvoir institutionnel |
| Plateformes technologiques | Incertitude juridique | NÉGATIF — Coûts de conformité |
| Citoyens européens | "Transparence" | INCERTAIN — Bénéfice réel non démontré |
| Citoyens non-européens | Exposition à la censure UE | NÉGATIF — Effet domino documenté |
| Gouvernement américain | Contre-narration | MOYEN — Maintien de l'influence US |
...
| Aspect | URSS 1930 | UE 2024 |
|--------|-----------|---------|
| Censeur | Commissaire du peuple (identifiable) | Algorithme + "communauté" (diffus) |
| Critères | "Anti-révolutionnaire = mort" (clairs) | "Borderline" (flous) |
| Résistance | Visible (dissidents emprisonnés) | Impossible (pas de procès) |
| Coût | Élevé (Goulag, exécutions) | Nul (downranking, demonetization) |
...
- **U.S. House Judiciary Committee, "The Foreign Censorship Threat — PART II"** (3 février 2026)
  [investigations/UE-censor/THE-FOREIGN-CENSORSHIP-THREAT-PART-II-2-3-26.pdf]
...
|---------|-------|----------------|
| **Faisceau d'indices** | 15/15 | 14 enquêtes, sources croisées multiples |
| **Sources primaires** | 15/15 | 7,826 lignes PDF + 302 exhibits analysés |
| **Vérification croisée** | 14/15 | Confirmation US House + EU Commission + cas documentés |
| **Traçabilité** | 15/15 | Lignes citées, exhibits numérotés, EU Democracy Shield documenté |
| **Puissance explicative** | 15/15 | Explique le système de A à Z + ce qui se prépare |
