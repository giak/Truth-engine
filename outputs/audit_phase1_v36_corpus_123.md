...
|---------|----|----|----|----------------|---------------|
| **C1** | 123 | 0 | 0 | 100.0% | 100.0% |
| **C2** | 123 | 0 | 0 | 100.0% | 100.0% |
| **C3** | 20 | 0 | 103 | 16.3% | 16.3% |
| **C5** | 123 | 0 | 0 | 100.0% | 100.0% |
| **C6** | 118 | 5 | 0 | 95.9% | 100.0% |
| **C7** | 123 | 0 | 0 | 100.0% | 100.0% |
| **C10** | 123 | 0 | 0 | 100.0% | 100.0% |
| **C10_strict** | 123 | 0 | 0 | 100.0% | 100.0% |
| **Δ Source** | 101 | 22 | 0 | 82.1% | 100.0% |
...
- `## 1. Métadonnées & trace source` : 123 occurrences
- `## 3. Acteurs nominaux` : 123 occurrences
- `## 4. Sources externes citées` : 123 occurrences
- `## 5. Chronologie datée` : 123 occurrences
- `## 6. Mécanismes / chaînes causales` : 123 occurrences
- `## 7. Verbatim et citations` : 123 occurrences
- `## 8. Notes méthodologiques source` : 123 occurrences
- `## 9. Limites connues (case-limites)` : 123 occurrences
- `## 2. Faits atomiques préservés` : 119 occurrences
