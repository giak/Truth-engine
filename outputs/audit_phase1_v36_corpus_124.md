...
|---------|----|----|----|----------------|---------------|
| **C1** | 124 | 0 | 0 | 100.0% | 100.0% |
| **C2** | 124 | 0 | 0 | 100.0% | 100.0% |
| **C3** | 20 | 0 | 104 | 16.1% | 16.1% |
| **C5** | 124 | 0 | 0 | 100.0% | 100.0% |
| **C6** | 119 | 5 | 0 | 96.0% | 100.0% |
| **C7** | 124 | 0 | 0 | 100.0% | 100.0% |
| **C10** | 124 | 0 | 0 | 100.0% | 100.0% |
| **C10_strict** | 124 | 0 | 0 | 100.0% | 100.0% |
| **Δ Source** | 102 | 22 | 0 | 82.3% | 100.0% |
...
- `## 1. Métadonnées & trace source` : 124 occurrences
- `## 3. Acteurs nominaux` : 124 occurrences
- `## 4. Sources externes citées` : 124 occurrences
- `## 5. Chronologie datée` : 124 occurrences
- `## 6. Mécanismes / chaînes causales` : 124 occurrences
- `## 7. Verbatim et citations` : 124 occurrences
- `## 8. Notes méthodologiques source` : 124 occurrences
- `## 9. Limites connues (case-limites)` : 124 occurrences
- `## 2. Faits atomiques préservés` : 120 occurrences
