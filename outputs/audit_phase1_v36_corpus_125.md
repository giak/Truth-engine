...
|---------|----|----|----|----------------|---------------|
| **C1** | 125 | 0 | 0 | 100.0% | 100.0% |
| **C2** | 125 | 0 | 0 | 100.0% | 100.0% |
| **C3** | 20 | 0 | 105 | 16.0% | 16.0% |
| **C5** | 125 | 0 | 0 | 100.0% | 100.0% |
| **C6** | 120 | 5 | 0 | 96.0% | 100.0% |
| **C7** | 125 | 0 | 0 | 100.0% | 100.0% |
| **C10** | 125 | 0 | 0 | 100.0% | 100.0% |
| **C10_strict** | 125 | 0 | 0 | 100.0% | 100.0% |
| **Δ Source** | 102 | 22 | 1 | 81.6% | 99.2% |
...
- `## 1. Métadonnées & trace source` : 125 occurrences
- `## 3. Acteurs nominaux` : 125 occurrences
- `## 4. Sources externes citées` : 125 occurrences
- `## 5. Chronologie datée` : 125 occurrences
- `## 6. Mécanismes / chaînes causales` : 125 occurrences
- `## 7. Verbatim et citations` : 125 occurrences
- `## 8. Notes méthodologiques source` : 125 occurrences
- `## 9. Limites connues (case-limites)` : 125 occurrences
- `## 2. Faits atomiques préservés` : 121 occurrences
