...
|---------|----|----|----|----------------|---------------|
| **C1** | 126 | 0 | 0 | 100.0% | 100.0% |
| **C2** | 126 | 0 | 0 | 100.0% | 100.0% |
| **C3** | 20 | 0 | 106 | 15.9% | 15.9% |
| **C5** | 126 | 0 | 0 | 100.0% | 100.0% |
| **C6** | 121 | 5 | 0 | 96.0% | 100.0% |
| **C7** | 126 | 0 | 0 | 100.0% | 100.0% |
| **C10** | 126 | 0 | 0 | 100.0% | 100.0% |
| **C10_strict** | 126 | 0 | 0 | 100.0% | 100.0% |
| **Δ Source** | 103 | 22 | 1 | 81.7% | 99.2% |
...
| `2026-08-14_09-00_opella-sanofi-cdr_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0/6 |
| `2026-08-14_10-00_atos-demantelement_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0/6 |
| `2026-08-14_11-00_carrefour-couche-tard_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0/6 |
| `2026-08-14_12-00_alcatel-nokia-asn_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0/6 |
| `2026-08-14_13-00_arabelle-edf-ge-steam-power_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ (2 fab.) | 6.0/6 |
| `2026-08-14_14-00_alstom-penal-ij-macron_quintessence.md` | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 6.0/6 |
...
- `## 1. Métadonnées & trace source` : 126 occurrences
- `## 3. Acteurs nominaux` : 126 occurrences
- `## 4. Sources externes citées` : 126 occurrences
- `## 5. Chronologie datée` : 126 occurrences
- `## 6. Mécanismes / chaînes causales` : 126 occurrences
- `## 7. Verbatim et citations` : 126 occurrences
- `## 8. Notes méthodologiques source` : 126 occurrences
- `## 9. Limites connues (case-limites)` : 126 occurrences
- `## 2. Faits atomiques préservés` : 122 occurrences
