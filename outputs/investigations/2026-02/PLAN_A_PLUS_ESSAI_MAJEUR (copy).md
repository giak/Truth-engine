...
Cette thèse est l'épine dorsale de l'essai. Elle explique :
...
Intrigue intellectuelle. Le lecteur doit se sentir devant une énigme qu'il veut résoudre.
...
**Où va-t-on ?**
- Chapitre 1 : le marquage médiatique (article Mediapart 2022, réactivé 2026)

**Transition vers Chapitre 1 :**
> "Ce que vous allez lire commence par une surprise. L'article censé déclencher la censure en 2026 date en réalité de 2022. Comprendre pourquoi un article de 2022 peut tuer une voix en 2026, c'est comprendre la machine..."
...
**Option A — Révélation chronologique (RECOMMANDÉE) :**
> "Ce que vous allez lire contient une surprise : l'article censé déclencher la censure d'Alexis Poulin en 2026 date en réalité du 6 novembre 2022. Cette découverte n'est pas une erreur. C'est la clé. Elle révèle un système qui ne censure pas dans l'instant : il réactive les dossiers quand il en a besoin. Une censure à la fois rétrospective et proactive."
...
**Section PROLOGUE.1 : La découverte chronologique**

- **Point clé à expliquer** : L'article Mediapart de Nils Dub date de 2022, pas de 2026
- **Faits/sources à citer** :
  ...
  - Mentionner les 3 hypothèses : réactivation stratégique, viralité algorithmique, convergence de regards
- **Concept à définir** : La censure rétrospective comme force narrative
- **Méthode d'explication** : Présenter la découverte comme fruit d'enquête, pas comme anecdote
- **Nuances nécessaires** :
...
## CHAPITRE 2 : LE RÉSEAU POULIN
### Durée indicative : 400-500 mots

#### Objectif narratif

**Qu'est-ce que ce chapitre doit accomplir ?**
- Dresser le portrait complet d'Alexis Poulin (trajectoire, réseau, influence)
- Montrer pourquoi il constituait une cible stratégique
- Introduire les acteurs secondaires de son réseau
...
> "Qui est l'homme marqué ? Alexis Poulin n'est pas un dissident lambda. C'est un journaliste avec une trajectoire singulière et un réseau qui expliquent pourquoi il a été ciblé."

**Transition vers Chapitre 3 :**
> "Mais si Poulin était sous surveillance depuis 2022, pourquoi le signal a-t-il été réactivé précisément en janvier 2026 ? C'est là que réside la vraie sophistication du système."
...
**Option A :**
> "Alexis Poulin n'est pas né journaliste 'rouge-brun'. Il est né consultant E&Y, a travaillé pour RSF, a co-fondé 'Le Média', et est devenu par la force des choses un dissident systémique."

**Option B :**
> "Pourquoi lui ? Parmi tous les journalistes critiques du pouvoir, pourquoi Mediapart a-t-il choisi de marquer Poulin ? La réponse tient à son réseau."

---

##### Développement

**Section 2.1 : Trajectoire biographique**

- **Point clé à expliquer** : Le parcours de Poulin
- **Faits/sources à citer** :
  - ◉ Sciences Po (formation)
  - ◈ E&Y (1999-2001) — période consultante
  - ◉ RSF (Reporters Sans Frontières) — période militante
  - ◈ "Le Média" — co-fondation, puis départ
  - ◉ Sud Radio (Fiducial) — chroniqueur régulier
  - ◈ "Le Monde Moderne" — chaîne YouTube indépendante
- **Concept à définir** : Trajectoire de la complicité à la dissidence
- **Méthode d'explication** : Chronologie narrative
- **Longueur indicative** : 120 mots

**Section 2.2 : Modèle économique et audience**

- **Point clé à expliquer** : Poulin comme entrepreneur médiatique indépendant
- **Faits/sources à citer** :
  - Revenus Patreon : $9k-$26k/mois (estimation VidIQ)
  - Plateformes : YouTube, X/Twitter, Sud Radio
  - Audience significative mais non mainstream
- **Concept à définir** : Journalisme indépendant comme modèle vulnérable
- **Méthode d'explication** : Montrer la fragilité économique du modèle
- **Longueur indicative** : 100 mots

**Section 2.3 : Le réseau géopolitique (acteurs secondaires)**

- **Point clé à expliquer** : Les connexions qui font de Poulin une cible stratégique
- **Faits/sources à citer** :
  - ◉ **Didier Maïsto** — parrain médiatique (Sud Radio)
  - ◉ **Dialogue Franco-Russe** — Yves Pozzo di Borgo, Thierry Mariani
  - ◉ **Francis Lalanne** — "Cheval de Troie Bio" (invité radical)
  - ◉ **François Asselineau** — allié souverainiste
  - ◉ **Sophie Chikirou** — contact historique (stratégie com)
- **Concept à définir** : Réseau comme cible (guilt by association)
- **Méthode d'explication** : Cartographie des connexions
- **Longueur indicative** : 150 mots

**Section 2.4 : Positions controversées**

- **Point clé à expliquer** : Pourquoi Poulin est contestable
- **Faits/sources à citer** :
  - Positions pro-russes documentées (OTAN, Ukraine)
  - Critiques virulentes de Macron
  - Conspirationnisme allégué (à nuancer)
- **Nuances nécessaires** :
  - Reconnaître explicitement ces positions
...
> "Poulin était donc marqué depuis 2022, avec un réseau exposé et une audience significative. Mais le vrai mystère n'est pas le marquage : c'est la réactivation. Comment un article de 2022 devient-il actuel en 2026 ?"
...
**Pourquoi ce chapitre est critique :**
- Il évite le piège du "martyr innocent"
- Il introduit les acteurs secondaires importants (Maïsto, Pozzo di Borgo, etc.)
- Il explique la ciblade stratégique

**Pièges à éviter :**
- ❌ Hagiographie de Poulin
- ❌ Oublier les positions controversées
- ❌ Omettre les acteurs secondaires du réseau

**Nuances absolument nécessaires :**
- ✅ Reconnaître les positions pro-russes documentées
- ✅ Mentionner le conspirationnisme allégué sans le confirmer ni le nier
...
| Source | Type | Contenu | Usage |
|--------|------|---------|-------|
| VidIQ/Patreon | ○ | Revenus $9k-$26k/mois | Modèle économique |
| APEX Investigation Poulin | ◈ | Trajectoire complète | Biographie |
| Réseau Dialogue F-R | ◉ | Pozzo di Borgo, Mariani | Contexte géopolitique |

### Concepts à définir

| Concept | Définition proposée | Métaphore |
|---------|-------------------|-----------|
| Guilt by association | Culabilité par connexion | Contamination sociale |
| Journalisme indépendant | Modèle économique sans protection institutionnelle | Nageur sans bouée |

### Checklist avant rédaction

- [ ] Trajectoire complète (Sciences Po → E&Y → RSF → Le Média → Sud Radio)
- [ ] Acteurs secondaires nommés (Maïsto, Pozzo di Borgo, Lalanne, Asselineau, Chikirou)
- [ ] Positions controversées mentionnées explicitement
- [ ] Modèle économique chiffré
...
**Section 3.2 : Le contexte de janvier 2026**

- **Point clé à expliquer** : Pourquoi janvier 2026 est un moment stratégique
- **Faits/sources à citer** :
...
**Section 10.4 : La doctrine de la porosité**

- **Point clé à expliquer** : Le concept qui permet de cibler les dissidents
- **Faits/sources à citer** :
  - ◈ Doctrine Viginum : "porosité"
  - Définition : "narratif interne résonnant avec narratif étranger"
  - Application : reclassification comme "agent de l'étranger" sans preuve
- **Concept à définir** : POROSITÉ (rappel)
...
**Section 19.2 : Les 5 vannes**

- **Point clé à expliquer** : Détailler chaque vanne
- **Faits/sources à citer** :
  1. **Vanne médiatique** : Label (Mediapart) — Chapitre 1
  2. **Vanne administrative** : Données (Nexus Marianne → ISD/CW) — Chapitre 4
  3. **Vanne algorithmique** : Détection (Viginum, DSA) — Chapitres 10-13
  4. **Vanne financière** : Débancarisation (PayPal/Stripe) — Chapitre 6
  5. **Vanne juridique** : Menace (Pack Effect, loi Tétier) — Chapitres 8-9
- **Métaphore** : "Les 5 doigts de la main invisible"
- **Longueur indicative** : 200 mots

**Section 19.3 : Application au cas Poulin**

- **Point clé à expliquer** : Comment les 5 vannes se sont fermées sur Poulin
- **Faits/sources à citer** :
  - Vanne 1 : Article Mediapart 2022 → réactivation 2026
  - Vanne 2 : Rapport ISD financé par Marianne
  - Vanne 3 : Détection Viginum/porosité
  - Vanne 4 : Risque de débancarisation
  - Vanne 5 : Menace judiciaire via Pack Effect
...
| Didier Maïsto | Parrain médiatique Poulin | Réseau | 2 |
...
|------|-----------|---------------|----------|
| 6 nov 2022 | Article Mediapart Nils Dub | Signal d'activation (dormant) | 1 |
