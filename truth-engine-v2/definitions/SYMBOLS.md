...
**Authority:** This is the ONLY file that defines symbols. KERNEL.md references this file.
**Version:** 2.0
...
|-----------|---------|-------------------|--------------|
| Ξ (Iceberg) | ≥5 | ≥3 | clusters/ICEBERG.md |
| € (Money) | ≥5 | ≥3 | clusters/MONEY.md |
...
**LOAD RULES:**
- Score ≥5 → LOAD cluster file (mandatory)
...
- Ξ → clusters/GASLIGHTING.md
- € → clusters/NETWORK.md + clusters/POWER.md
- Ω → clusters/CONFIRMATION.md

---

## §5 CLAMPS (maximum scores)
...
## §6 RESONANCE (symbol interactions)
...
- **5-6:** BRANCH "Hidden reality" → forensic/REASONING.md + 2 queries
...
- **7-8:** DEEP_DIVE "Dark money" → clusters/MONEY.md + clusters/NETWORK.md + 3 queries
- **9-10:** EXPOSE "Systemic corruption" → SEC + court docs + leaked data

### Λ FRAMING [score]
- **3-4:** NOTE "frame imposed" → +1 query alternatives
- **5-6:** BRANCH "Frame deconstruction" → clusters/FRAMING.md + 2 queries
...
- **5-6:** BRANCH "Reality check" → clusters/INVERSION.md + 2 queries
...
- **5-6:** BRANCH "Overload analysis" → clusters/OVERLOAD.md + 2 queries
...
- **5-6:** BRANCH "Stratification analysis" → clusters/TEMPORAL.md + 2 queries
...
- **5-6:** BRANCH "Behind curtain" → clusters/SPECTACLE.md + 2 queries
...
- **5-6:** BRANCH "Semiotic analysis" → clusters/FRAGMENTATION.md + 2 queries
...
- **5-6:** BRANCH "Institutional analysis" → clusters/GASLIGHTING.md + 2 queries
...
- **5-6:** BRANCH "Resistance mapping" → clusters/RESISTANCE.md + 2 queries
...
- **5-6:** BRANCH "Choice architecture" → clusters/CONFIRMATION.md + 2 queries
...
- **5-6:** BRANCH "Warfare analysis" → clusters/WAR.md + 2 queries
...
- **5-6:** BRANCH "Network mapping" → clusters/NETWORK.md + 2 queries
