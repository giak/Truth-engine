...
**Pattern:** 3-4:NOTE(+1q) | 5-6:BRANCH(clusters+2q) | 7-8:DEEP_DIVE(specific+3q) | 9-10:EXPOSE(max resources)
**See protocol/INVESTIGATION.md §1 for branch names + cluster refs. See §4 for cluster thresholds.**
